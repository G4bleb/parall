...
//  Created by flemieux on 2013-11-30.

//  Copyright (c) 2013 flemieux. All rights reserved.
...
int main() {
    ...
    clGetDeviceInfo(devices[1], CL_DEVICE_MAX_WORK_GROUP_SIZE, sizeof(size_t),
                    &MaxGroup, NULL);
    ...
    clGetDeviceInfo(devices[1], CL_DEVICE_MAX_WORK_ITEM_SIZES,
                    3 * sizeof(size_t), MaxItems, NULL);

    printf("CL_DEVICE_MAX_WORK_ITEM_SIZES = (%d, %d, %d)\n", (int)MaxItems[0],
           (int)MaxItems[1], (int)MaxItems[2]);
